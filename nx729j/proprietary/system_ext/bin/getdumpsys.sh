...
if [ ! -n "$trim_reason" ]; then
    ...
    echo "        dumpsys user" >> dumpsys_screenshots.txt
    echo "----------------------------------------" >> dumpsys_screenshots.txt
    dumpsys -t 30 user -a >> dumpsys_screenshots.txt
    echo "----------------------------------------" >> dumpsys_screenshots.txt
    ...
    if [ x"$platform" = "xlito" ] || [ x"$platform" = "xlahaina" ] || [ x"$platform" = "xkona" ] || [ x"$platform" = "xtaro" ] || [ x"$platform" = "xkalama" ]; then
        echo "----------------------------------------" >> dumpsys_screenshots.txt
